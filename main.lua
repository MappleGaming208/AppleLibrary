...
-- changed it from TextColor3 = Color3.fromRGB(95, 95, 95) to TextColor3 = Color3.fromRGB(160, 160, 160)
local lib = {}
local sections = {}
local workareas = {}
local notifs = {}
...
function lib:init(ti, dosplash, visiblekey, deleteprevious)
    ...
    if dosplash then
        ...
        splash.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
        ...
        sicon.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
        ...
        ug.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(19, 19, 19)), ColorSequenceKeypoint.new(0.01, Color3.fromRGB(61, 61, 61)), ColorSequenceKeypoint.new(0.47, Color3.fromRGB(41, 41, 41)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))}
        ug.Rotation = 90
        ug.Parent = sicon
    ...
    workarea.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
    ...
    workareacornerhider.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
    ...
    search.Name = "search"
    search.Parent = main
    search.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
    ...
    searchicon.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
    ...
    searchtextbox.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
    ...
    sidebar.Parent = main
    sidebar.Active = true
    sidebar.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
    ...
    buttons.Parent = main
    buttons.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
    ...
    notificon.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
    ...
    notifbutton1.TextColor3 = Color3.fromRGB(19, 19, 19)
    ...
    notiftitle.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
    ...
    notiftext.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
    ...
    notif2.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
    ...
    notif2icon.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
    ...
    notif2title.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
    ...
    notif2text.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
    ...
    notif2button1.TextColor3 = Color3.fromRGB(19, 19, 19)
    ...
    function window:TempNotify(text1, text2, icon)
        ...
        tempnotif.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
        ...
        t2.Name = "t2"
        t2.Parent = tempnotif
        t2.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
        ...
        t1.Name = "t1"
        t1.Parent = tempnotif
        t1.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
        ...
        ticon.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
    ...
    function window:Divider(name)
        ...
        sidebardivider.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
    ...
    function window:Section(name)
        ...
        workareamain.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
        ...
        function sec:Select()
            ...
            sidebar2.TextColor3 = Color3.fromRGB(19, 19, 19)
        ...
        function sec:Label(name)
            ...
            label.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
        ...
        function sec:Switch(name, defaultmode, callback)
            ...
            toggleswitch.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
        ...
        function sec:TextField(name, placeholder, callback)
            ...
            textfield.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
